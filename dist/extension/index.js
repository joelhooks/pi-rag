...
export default function piRagExtension(pi) {
    ...
    pi.registerTool({
        ...
        async execute(_id, params) { return text(await getService().getStructure(params.sessionId, params.refresh)); },
    });
    pi.registerTool({
        ...
        async execute(_id, params) { return text(await getService().searchTree(params.sessionId, params.query, { fanout: params.fanout, maxDepth: params.maxDepth })); },
    });
    pi.registerTool({
        ...
        async execute(_id, params) { return text(await getService().getContent(params.sessionId, params)); },
    });
    pi.registerTool({
        ...
        async execute(_id, params) { return text(await getService().summarizeNode(params.sessionId, params.nodeId, { usePi: params.usePi })); },
    });
}
