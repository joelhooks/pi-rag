...
if [ -d "$(dirname "$GATEWAY_EXT_DIR")" ]; then
  mkdir -p "$GATEWAY_EXT_DIR"
  ln -sfn "$TARGET/dist/index.js" "$GATEWAY_EXT_DIR/pi-rag.js"
fi
...
gateway extension: $GATEWAY_EXT_DIR/pi-rag.js
